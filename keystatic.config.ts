...
export default config({
  ...
  collections: {
    ...
    projects: collection({
      ...
      schema: {
        ...
        image: fields.image({
          ...
          description: "Optional project image; a visual fallback is shown when empty",
        }),
        startDate: fields.date({
          label: "Start Date",
          description: "Optional when the resume or publication does not specify a date",
        }),
        endDate: fields.date({
          label: "End Date",
          description: "Leave empty if ongoing",
    ...
    hackathons: collection({
      ...
      schema: {
        title: fields.slug({
          name: { label: "Competition Name (English)" },
        }),
        titleZh: fields.text({
          label: "Competition Name (Chinese)",
          validation: { isRequired: true },
        }),
        award: fields.text({
          label: "Award (English)",
        ...
        tier: fields.select({
          ...
          options: [
            ...
            { label: "Provincial / Ministerial", value: "provincial" },
            { label: "School", value: "school" },
          ],
          defaultValue: "national",
        }),
        awardOrder: fields.integer({
          label: "Prize Rank",
          description: "1 = first/gold, 2 = second/silver, 3 = third/bronze",
          defaultValue: 3,
        }),
        sortOrder: fields.integer({
          label: "Order Within Same Rank",
          defaultValue: 999,
        }),
        location: fields.text({
          label: "Location",
        ...
        description: fields.text({
          ...
          multiline: true,
          description: "Optional certificate or team details",
        }),
        descriptionZh: fields.text({
        ...
        startDate: fields.date({
          label: "Start Date",
          description: "Optional when the date is not available",
        }),
        endDate: fields.date({
          label: "End Date",
        ...
        certificate: fields.image({
          ...
          directory: "src/assets/awards",
          publicPath: "@assets/awards/",
          description: "Leave empty until the certificate is available",
        }),
        rotateCertificate: fields.checkbox({
          label: "Rotate Certificate Clockwise",
          description: "Use for sideways certificate photographs",
          defaultValue: false,
        }),
        sourceLink: fields.url({
          label: "Project Link",
